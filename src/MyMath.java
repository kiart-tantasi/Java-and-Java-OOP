...
//        System.out.println("\nFloor of float '3.78' is '" + Math.floor(floatNum) + "'"); // <-- the type of Math.floor()'s result is going to be double.
...
// Typetester from https://stackoverflow.com/questions/3993982/how-to-check-type-of-variable-in-java
//class Typetester {
